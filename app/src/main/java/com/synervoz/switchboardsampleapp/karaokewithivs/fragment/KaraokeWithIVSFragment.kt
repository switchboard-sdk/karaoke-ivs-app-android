package com.synervoz.switchboardsampleapp.karaokewithivs.fragment
...
import com.synervoz.switchboardsampleapp.karaokewithivs.audio.KaraokeWithIVSExample
...
class KaraokeWithIVSFragment : Fragment() {

    companion object {
        val TAG = this::class.java.name
    }

    private lateinit var example: KaraokeWithIVSExample
    ...
    override fun onCreateView(
        ...
        example = KaraokeWithIVSExample(requireContext())
