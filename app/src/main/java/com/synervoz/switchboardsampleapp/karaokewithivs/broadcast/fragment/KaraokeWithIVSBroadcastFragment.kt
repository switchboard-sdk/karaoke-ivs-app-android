...
class KaraokeWithIVSBroadcastFragment : Fragment() {
    ...
    private fun shareStreamLink() {
        ...
        val streamLink = "https://c870567d09d7.us-west-2.playback.live-video.net/api/video/v1/us-west-2.145723686246.channel.QH17qa3VLI0B.m3u8"
        val streamTester = "\n\nYou can also use the above link in https://viloud.tv/hls-stream-tester/"
        intent.putExtra(Intent.EXTRA_TEXT, streamLink + streamTester)
